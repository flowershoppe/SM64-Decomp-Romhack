...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_1UP, -144, 1482, 98, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_1UP, -144, 1482, 98, 0, 0, 0, 0x00000000, bhv1Up),
		...
		MARIO_POS(0x01, 180, -62, 0, 6144),
		OBJECT(MODEL_RED_COIN, 1215, 539, 6721, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -109, 47, 2832, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		...
		OBJECT(MODEL_SPARKLES_ANIMATION, 1694, 295, 295, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
