...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -109, 47, 2832, 0, 0, 0, (5 << 24), bhvHiddenRedCoinStar),
		...
		OBJECT(MODEL_RED_COIN, 2824, 257, 4443, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_INTERACTIVE_TABLET_PODIUM, 3127, -4, -1565, 0, 180, 0, (1 << 24) | (1 << 16), bhvInteractiveTabletPodium),
		OBJECT(MODEL_SILVER_STAR, -4523, 321, 985, 0, 180, 0, (1 << 24), bhvSilverStar),
		OBJECT(MODEL_SILVER_STAR_PODIUM, -4523, 321, 385, 0, 180, 0, (1 << 24), bhvSilverStarPodium),
		...
		OBJECT(MODEL_INTERACTIVE_TABLET, 2277, -4, -1565, 0, 180, 0, (1 << 24), bhvInteractiveTablet),
		OBJECT(MODEL_INTERACTIVE_TABLET, 2302, -4, -1965, 0, 180, 0, (1 << 24), bhvInteractiveTablet),
		OBJECT(MODEL_INTERACTIVE_TABLET, 2302, -4, -2365, 0, 180, 0, (1 << 24), bhvInteractiveTablet),
		OBJECT(MODEL_INTERACTIVE_TABLET, 2402, -4, -3315, 0, 180, 0, (1 << 24), bhvInteractiveTablet),
