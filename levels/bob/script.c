...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_CUSTOM_PEACH, 300, 0, -300, 0, 0, 0, (109 << 16), bhvCustomPeach),
		OBJECT(MODEL_BOB_BUBBLY_TREE, 1100, 0, 1300, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_BOB_BUBBLY_TREE, -1400, 0, 1300, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_BOB_BUBBLY_TREE, -600, 0, -1200, 0, 0, 0, 0x00000000, bhvTree),
