...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		WARP_NODE(0x01, LEVEL_BOB, 0x01, 0x01, WARP_CHECKPOINT),
		WARP_NODE(0x02, LEVEL_JRB, 0x01, 0x01, WARP_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 3935, -20, 150, 0, -90, 0, (0 << 24) | (0x02 << 16), bhvWarp),
		OBJECT(MODEL_NONE, -2072, 99, 4699, 0, 180, 0, (0 << 24) | (0x01 << 16), bhvWarp),
