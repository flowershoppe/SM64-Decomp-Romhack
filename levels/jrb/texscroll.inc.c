...
void scroll_jrb_dl_Cube_072_mesh_layer_1_vtx_1() {
	int i = 0;
	int count = 7;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(jrb_dl_Cube_072_mesh_layer_1_vtx_1);
...
void scroll_jrb() {
	...
	scroll_jrb_dl_Cube_072_mesh_layer_1_vtx_1();
};
