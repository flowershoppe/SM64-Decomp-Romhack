...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		WARP_NODE(0x03, LEVEL_WF, 0x01, 0x04, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -412, 210, 690, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, 362, 210, 690, 0, 0, 0, (0x01 << 16), bhvAirborneWarp),
		OBJECT(MODEL_NONE, -438, 210, 690, 0, 0, 0, (0x03 << 16), bhvWarp),
